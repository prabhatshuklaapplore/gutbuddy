...
import {
  dietCategoryTableColumns,
  dietCategoryFormFields,
} from "../../constants/dietCategoriesPage";
const Users = () => {
    ...
    <>
      <Layout>
        <div style={{ padding: "1rem" }}>
          <Typography variant="h5">Diet Category</Typography>
          <div
            style={{
              display: "flex",
          ...
          <CustomTable
            data={users}
            columns={dietCategoryTableColumns}
      ...
      <FormModal
        ...
        fields={dietCategoryFormFields}
        header={editModal ? "Edit Diet Category" : "Add Diet Category"}
